    ...
    <div className='border-t-2 pt-10 transition-opacity ease-in duration-500 opacity-100'>
      ...
      <div className='flex gap-12 sm:gap-12 flex-col sm:flex-row'>
        ...
        <div className='flex-1 flex flex-col-reverse gap-3 sm:flex-row'>
          <div className='flex sm:flex-col overflow-hidden justify-between sm:justify-normal sm:w-[16.5%] w-full'>
              {
          ...
          <div className='flex-1/2'>
              ...
              <div className='flex flex-col gap-4 my-8'>
                ...
                <button className='bg-black text-white px-8 py-3 text-sm active:bg-gray-700 w-1/2'>ADD TO CART</button>
      ...
      {/* ---------------Description and review section---------------- */}
          <div className='mt-20'>
            ...
            <div className='flex flex-col gap-4 border px-6 py-6 text-sm text-gray-500'>
                  <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Id, distinctio. Laboriosam velit tenetur eos culpa cumque nisi, quod perspiciatis molestiae possimus repellat labore sapiente fugiat consectetur odio at ullam fugit.</p>
