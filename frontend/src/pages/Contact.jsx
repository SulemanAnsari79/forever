    ...
    <div>
      ...
      <div className='my-10 flex flex-col justify-center md:flex-row gap-10 mb-28'>
        ...
        <div className='flex flex-col justify-center items-start gap-6'>
          ...
          <p className='text-gray-500'>274 Mohalla Hunadal Khel,<br />Shahjahanpur, Uttar Pradesh-242001</p>
          <p className='text-gray-500'>Tel: 6386514515 <br />Email: work.suleman01@gmail.com</p>
